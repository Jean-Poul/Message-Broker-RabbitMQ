package jplm.dk.mom.rabbitmq.rabbitmqdemo.header;
...
public class HeaderExchange {
    ...
    public static void declareBindings() throws IOException, TimeoutException {
        ...
        sportsArgs.put("x-match", "all"); //Match all the header
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        HeaderExchange.declareQueues();
        HeaderExchange.declareExchange();
        HeaderExchange.declareBindings();
        //Threads created to publish-subscribe asynchronously
        Thread subscribe = new Thread() {
            @Override
            public void run() {
                try {
                    HeaderExchange.subscribeMessage();
